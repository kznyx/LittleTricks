...
DWORD WINAPI ThreadProc(_In_ LPVOID lpParameter){
    std::cout << "ThreadProc exec" << std::endl;
    return 0;
}
...
int ExecShellCode(char* shellcode, int len){
    ...
    hThread = CreateThread(NULL, 0, (LPTHREAD_START_ROUTINE)ThreadProc, NULL, CREATE_SUSPENDED, NULL);
    if (!hThread){
        std::cout << "[-] create thread failed, error code: " << GetLastError() << std::endl;
        return -1;
    }
    ...
    std::cout << "[+] resume thread proc" << std::endl;
